...
from .torch_trt_utils.tensorrt.tensorrt_executor import TensorRTExecutor
...
class BaseTool(metaclass=ABCMeta):
    ...
    def __init__(self,
        ...
        if backend == 'opencv':
            ...
            cuda_id = int(device.replace('cuda:', ''))
            self.session = TensorRTExecutor(onnx_model, cuda_id=cuda_id)
