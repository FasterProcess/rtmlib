...
class Wholebody:
    ...
    MODE = {
        'performance': {
            'det':
            # './model/yolox_m_8xb8-300e_humanart-fixed2.onnx',  # noqa
            './model/modified_onnx/modified_yolox_m_8xb8-300e_humanart-c2c7a14a.onnx.onnx',
            # './model/yolox_m_8xb8-300e_humanart-fixed2.trt',
            'det_input_size': (640, 640),
            'pose':
            './model/rtmw-dw-x-l_simcc-cocktail14_270e-384x288_20231122_static.onnx',  # noqa
            # './model/rtmw-dw-x-l_simcc-cocktail14_270e-384x288_20231122.trt',
